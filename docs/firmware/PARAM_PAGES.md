...
(`docs/firmware/MAINMENU.md` §9c-ii) writes even slots only — a MODE there can be set
...
| 10 | `$e` | knob, bits 16–23 | GATE / PTCH (7 Sep 2026; -DEL 5–7 Sep, DRV before) |
...
rather than stored, `tools/build/stock_labels.py` simply *calls* every stock
