; ---------------------------------------------------------------------------
; reverb v33 -- generated by tools/gen_reverb.py, do not hand-edit
;
...
; Read X:$213 HERE, in process, with no stash and no absolute Y at all.
;
; v23 did this and hung, which is why the stash exists -- but v23 ALSO kept its
; state in r7+$84..$8a, and v26/v27 later proved that alone is fatal. The
; process-time read was never tested on its own; the conclusion that it is
; invalid was drawn from a confounded build.
        move    x:>$213,r4
