; ---------------------------------------------------------------------------
; v42 -- generated by tools/gen_reverb.py, do not hand-edit
;
...
; given 0x4000 words:
;   lines      base+0x0000 .. base+0x03ff   256 words each
;              taps 195 156 122 91  (4 4 3 2 ms)
...
;   base+0x0400   LFO phase and 4 damping states, loaded per block
...
; measured, r7 = 0x6200 while the base is table[1], not table[2].
        ...
        add     y0,a
        move    a,r5
        move    #>$ff,m1     ; both fill the AGU slot
        move    #>$ffffff,m5
...
;
;   0x1000 0x1c00 0x2800 0x3400   FX1 slots, 0xc00 words. A 0x400-word
...
; ---- fixed taps: no parameter reaches an address ------------------------
        move    #>$ffff3d,n1         ; -195, line 0 reads y:(r1+n1)
        move    #>$ffff64,n2         ; -156, line 1 reads y:(r2+n2)
        move    #>$ffff86,n3         ; -122, line 2 reads y:(r3+n3)
        move    #>$ffffa5,n4         ; -91, line 3 reads y:(r4+n4)
...
; ---- wet added to dry, two tank taps per channel -------------------------
        ...
        move    x:(r7+$17),a            ; line 1, tap 156
        move    x:(r7+$18),x0           ; line 2, tap 122
        add     x0,a
        asr     #$1,a,a
        move    a,x:(r7+$2d)            ; wet L
        move    x:(r7+$16),a            ; line 0, tap 195
        move    x:(r7+$19),x0           ; line 3, tap 91
        add     x0,a
        asr     #$1,a,a
