; ---------------------------------------------------------------------------
; v43 -- generated by tools/gen_reverb.py, do not hand-edit
;
...
; ---- four taps, damped inside the feedback path -------------------------
        ...
        move    y:(r1+n1),a         ; line 0, fixed tap 195
        move    x:(r7+$3a),b
        sub     b,a
        move    a,x0
        mpy     x0,y0,a
        ...
        move    y:(r2+n2),a         ; line 1, fixed tap 156
        move    x:(r7+$3b),b
        sub     b,a
        move    a,x0
        mpy     x0,y0,a
        ...
        move    y:(r3+n3),a         ; line 2, fixed tap 122
        move    x:(r7+$3c),b
        sub     b,a
        move    a,x0
        mpy     x0,y0,a
        ...
        move    y:(r4+n4),a         ; line 3, fixed tap 91
        move    x:(r7+$3d),b
        sub     b,a
        move    a,x0
        mpy     x0,y0,a
