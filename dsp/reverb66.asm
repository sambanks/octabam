...
; ---- rebuild the four delay pointers from the saved phase ----------------
    ...
    ; Setup only -- this runs once per block, not per sample.
            ...
            move    #>$3FB800,x0            ; 2039 as a fraction of 2048
            mpy     x0,x1,a
            ...
            move    #>$32D800,x0            ; 1627 as a fraction of 2048
            mpy     x0,x1,a
            asr     #$b,a,a                 ; back to an integer tap
            move    #>$800,b
            sub     a,b                     ; 2048 - tap, for the modulated read
            move    b,x:(r7+$2a)
            move    #>$27E800,x0            ; 1277 as a fraction of 2048
            mpy     x0,x1,a
            asr     #$b,a,a                 ; back to an integer tap
            move    #>$800,b
            sub     a,b                     ; 2048 - tap, for the modulated read
            move    b,x:(r7+$2b)
            move    #>$1DC800,x0            ; 953 as a fraction of 2048
            mpy     x0,x1,a
            asr     #$b,a,a                 ; back to an integer tap
            move    #>$800,b
            sub     a,b                     ; 2048 - tap
