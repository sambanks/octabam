...
; the user hears as metallic when the wet is turned up.
        ...
        move    #>843,a
        move    a,x:(r7+$63)            ; 1024 - 181, line 2
        move    #>755,a
        move    a,x:(r7+$64)            ; 1024 - 269, line 3
...
; -- in-loop allpass, line 1: diffuses the feedback before it is stored --
        ...
        sub     x0,a
; -- in-loop allpass, line 2: diffuses the feedback before it is stored --
        move    a,x1                    ; x = the value bound for the line
        move    x:(r7+$63),a
        move    a,n5                    ; 1024 - tap
        move    x:(r7+$39),a            ; phase (already masked to $3ff)
        ...
        move    x:(r7+$27),x0           ; diffused input, half
        add     x0,a
; -- in-loop allpass, line 3: diffuses the feedback before it is stored --
        move    a,x1                    ; x = the value bound for the line
        move    x:(r7+$64),a
        move    a,n5                    ; 1024 - tap
        move    x:(r7+$39),a            ; phase (already masked to $3ff)
