; ---------------------------------------------------------------------------
; v47 -- generated by tools/gen_reverb.py, do not hand-edit
;
...
; tank gets no input, and the reverb goes completely silent.
        move    x:(r6+$e),a
        asr     #$c,a,a
        move    a,x:(r7+$29)            ; PRE in samples
        move    x:(r7+$83),a            ; the same counter again
        move    #>$7ff,x0
        and     x0,a
        move    a,x:(r7+$30)            ; the pre-delay phase, an OFFSET now --
...
; modulo access has frozen and the one build with none has not.
        move    x:(r7+$1b),a            ; hold the input
        move    a,x:(r7+$14)
        move    x:(r7+$30),a            ; read at phase - PRE - 1
        move    x:(r7+$29),x0
        sub     x0,a
        move    #>$1,x0
        sub     x0,a
        ...
        move    #>$ffffff,m1
        move    y:(r5),b                ; delayed
        move    x:(r7+$30),a            ; write at phase
        move    #>$7ff,x0
        and     x0,a
        move    x:(r7+$38),x0
        add     x0,a
        move    a,r5
        move    b,x:(r7+$1b)            ; delayed -> the diffuser; fills the slot
        move    x:(r7+$14),a            ; the input again
        move    a,y:(r5)
        move    x:(r7+$30),a            ; advance the phase
        move    #>$1,x0
        add     x0,a
        move    #>$7ff,x0
        and     x0,a
