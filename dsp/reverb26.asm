; ---------------------------------------------------------------------------
; reverb v26 (base hardcoded, bisect) -- generated by tools/gen_reverb.py, do not hand-edit
;
...
; tank gets no input, and the reverb goes completely silent.
        ...
        move    a,n5                    ; staleness
        move    x:(r7+$86),a               ; rebuild the pre-delay pointer
        move    #>$7ff,x0
        and     x0,a
        move    x:(r7+$78),x0
        add     x0,a
...
; ---- LFO: one triangle and its inverse ----------------------------------
        move    x:(r7+$85),a               ; persistent phase, [0,$7fffff]
...
; -- allpass 0: base+0x2000, tap 907 (20.6 ms) --
        ...
        sub     a,b                     ; out = d - g*v
        move    b,x:(r7+$5b)
        move    x:(r7+$84),a               ; write v at base + phase
        move    x:(r7+$72),x0
        add     x0,a
        move    a,r5
...
; -- allpass 3: base+0x2c00, tap 331 (7.5 ms) --
        ...
        move    x:(r7+$84),a               ; advance the shared allpass phase
        move    #>$1,x0
        add     x0,a
        move    #>$3ff,x0
        and     x0,a
