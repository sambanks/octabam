; ---------------------------------------------------------------------------
; reverb v23 -- generated by tools/gen_reverb.py, do not hand-edit
;
...
; X:$213 points at our entry in the host's table of per-instance bases.
...
; ---- absolute bases, once per block -------------------------------------
        ...
        move    #>$800,a
        add     x0,a
        move    a,x:(r7+$76)            ; modulated line 1
        move    #>$1000,a
        add     x0,a
        move    a,x:(r7+$77)            ; modulated line 2
        move    #>$3000,a
        add     x0,a
