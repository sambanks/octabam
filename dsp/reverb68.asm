...
; register write next to its address register is the interlock that froze v47.
        move    #>$7ff,n1               ; line/phase mask
        move    #>$3ff,n2               ; allpass mask
        move    #>$5a0000,n3            ; allpass coefficient
...
; ---- input: mono sum -----------------------------------------------------
        ...
        move    n2,x0       ; both advance by 1 a sample, and the
...
; -- allpass 0: base+0x2000, tap 907 (20.6 ms) --
        ...
        add     x0,a
        move    a,r5
        move    n3,y0            ; coefficient 0.703 (was 0.5). Denser
