...
lf3e:
        ...
        mpy     x0,y1,a
        move    a1,x0                   ; v75: scale by SIZE too, so the sweep
        move    x:(r7+$62),y1           ; stays a constant PERCENTAGE of the
        mpy     x0,y1,a                 ; tap. Absolute 126 samples was 65% of
        move    a1,x1                   ; a 195-sample tap at SIZE=0.
        asl     #$8,a,a
        move    a2,x0
