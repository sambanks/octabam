...
emulator, and measure the metallic artifact numerically.
    ...
    python3 tools/harness/send_probe.py                     # current working tree
    python3 tools/harness/send_probe.py --wav out/send.wav  # ... and keep the audio
...
def run(mem, dur, tail, rev_params, send_params, verbose=False, amp=0.5,
    ...
    if direct:
        ...
        #
        # D needs a DEV=1 image (tools/build/build_bus.py): XBUS=1 stubs the DELAY
