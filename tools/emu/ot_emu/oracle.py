#!/usr/bin/env python3
"""THE ORACLE DIFF: does the C++ port (tools/emu/ot_emu) reach the same machine
state route A (tools/emu/emu_rtos.py) reaches?

    .venv/bin/python3 tools/emu/emu_rtos.py --until-gate --ms 1000 --golden out/oracle/m6a.json
