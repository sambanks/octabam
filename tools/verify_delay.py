#!/usr/bin/env python3
"""Prove an alternate BusDelay engine is BIT-IDENTICAL to the shipping one.

    python3 tools/verify_delay.py modules/busdelay/delay_server2.asm
    python3 tools/verify_delay.py cand.asm --ref modules/busdelay/delay_server.asm
...
def main():
    ...
    ap.add_argument("candidate", help="the engine under test, e.g. modules/busdelay/delay_server2.asm")
    ap.add_argument("--ref", default=registry.asm("busdelay"),
