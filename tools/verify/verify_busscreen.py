...
0x4003a474 (built; the value-move is the flash question, docs/firmware/MAINMENU.md
...
def main():
    ...
    # staged page and SPINS on a cold machine (docs/firmware/MAINMENU.md 9c-ii). On
