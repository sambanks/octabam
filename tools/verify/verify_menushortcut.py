...
"""The MAIN MENU really gains REVERB and DELAY -- walked, not read.
    ...
    python3 tools/verify/verify_menushortcut.py [remix]      (default: bamsep26)
...
state the handler is called in. docs/firmware/MAINMENU.md section 7 prices it, and the
flash is the test.
"""
import os
import pathlib
