...
the hand-maintained 8-line modules/busverb/reverb_server.asm (ROOM/PLATE/BIG, rolled
...
Emit the reverb DSP source from a configuration.
    ...
    python3 tools/build/gen_reverb.py [name] > dsp/reverbNN.asm
...
def main():
    ...
    body = f"""; ---------------------------------------------------------------------------
; {sys.argv[1] if len(sys.argv) > 1 else 'reverb'} -- generated by tools/build/gen_reverb.py, do not hand-edit
;
