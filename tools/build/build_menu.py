#!/usr/bin/env python3
"""
SUPERSEDED by tools/build/build_bus.py (the shipping builder) -- kept as the
...
DELAY SERVER, REVERB SERVER, SEND.
    ...
    python3 tools/build/build_menu.py
...
(tools/verify/verify_menu.py) before ever flashing. It does NOT yet place
...
# the numbers themselves). 0x06 is the exact id tools/build/build_dspprobe.py
...
def main():
    ...
    print("see tools/verify/verify_menu.py, checked against the real chooser functions")
