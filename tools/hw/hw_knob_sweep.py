...
MIDI on the unit with tools/hw/hw_bus_test.py (T5 soloed, Rytm transport, EVO
...
parameter in out/hw/bustest/sweep.log, then a live/dead summary.
    ...
    python3 tools/hw/hw_knob_sweep.py            # BusVerb host on ch5
    python3 tools/hw/hw_knob_sweep.py --ch 1     # BusDelay host on ch1 (page-2 counts differ)
...
VERB = [
    (41, "TIME", 0, 127), (42, "MOD", 0, 127), (43, "SIZE", 0, 127), (44, "TONE", 0, 127), (45, "MIX", 0, 127),
...
def main():
    ...
    with LOG.open("a") as log:
        ...
        for cc, name, a, b in params:
            cmd = [sys.executable, "tools/hw/hw_bus_test.py", "--ch", str(args.ch), "--period", str(args.period),
