...
Usage:
    python3 tools/hw/hw_bus_test.py                 # default: reverb on ch5,
                                                 #   control TIME(40), test MODE(62)
    python3 tools/hw/hw_bus_test.py --ch 5 --test 63 --a 0 --b 127 \
        --control 40 --ca 127 --cb 0 --period 1.5 --cycles 8

Prereqs: EVO4 capturing the rig's master; transport driven by the Rytm
(master); tools/hw/rec (compile: swiftc -O tools/hw/rec.swift -o tools/hw/rec).
"""
import argparse
import array
import math
