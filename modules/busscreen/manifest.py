...
HANDLER = bytes.fromhex(
    "")
...
def emit(addr):
    ...
    nslot_here = body_off + len(data)
    data.extend((12).to_bytes(4, "big"))             # slots shown: 12, or 13 with the return row
    rvrb_here = body_off + len(data)
    data.extend(b"RVRB\0")
    dly_here = body_off + len(data)
    data.extend(b"DLY\0")
    while (body_off + len(data)) % 4:
        data.append(0)
    ...
    targets = {
        ...
        "rvrbstr": addr + rvrb_here,
        "dlystr": addr + dly_here,
        "nslot": addr + nslot_here,
    }
